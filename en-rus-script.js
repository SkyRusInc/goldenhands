document.addEventListener("DOMContentLoaded", function() {
    ...
    const translations = {
        ...
        "ru": {
            ...
            "expertisefirstline": "Координация и выполнение транспортных услуг, включая безопасную обработку громоздких и хрупких предметов.",
            "expertisesecondline": "Профессиональная сборка всех типов мебели, включая сложные конструкции",
            "expertisethirdline": "Установка бытового и офисного оборудования с точностью и заботой.",
            ...
            "contact-text": "Наша команда доступна для вас ежедневно с 7 утра до 7 вечера.",
            ...
            "notification-error": "Ошибка: Пожалуйста, проверьте следующее: Поле имени не может быть пустым . Адрес электронной почты должен быть действительным. Поле сообщения не может быть пустым",
            "reviewlink": "Отзывы",
